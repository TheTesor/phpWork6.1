 ...
 */
class getRefreshTokenHistoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RefreshTokenHistoryRepository' shared autowired service.
     *
     * @return \App\Repository\RefreshTokenHistoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RefreshTokenHistoryRepository.php';

        return $container->privates['App\\Repository\\RefreshTokenHistoryRepository'] = new \App\Repository\RefreshTokenHistoryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
